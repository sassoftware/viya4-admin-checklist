...
SAS users are used to having their operating system home-directories available while they work. SAS Viya requires additional configuration to make home directories available. In addition SAS Viya does not support automatic creation of home directories, home directories must be created.
...
* Update the identities configuration to set the identifier.homeDirectoryPrefix prefix property with the path to the location where the home directories reside
...
* [Identity Management: The CASHostAccountRequired Custom Group](https://go.documentation.sas.com/doc/en/sasadmincdc/default/calids/p0ata1oqy9v7nan188h1k254doxq.htm#p1b0uixk221q3jn19ztuitir62gm) [Doc]
